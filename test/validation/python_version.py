...
def find_solutions(x1, x2):
	...
	if(np.sign(delta_start) != np.sign(delta_stop)):
		...
		print("not solution with logC0 > {:.3f} exists".format(result.x[0]))
...
def main():
	print "Test 1: Index ",n(-10)
	print "Test 2: Gamma ",get_gamma(-10)
	print "Test 3: Turning Point ",get_turning_point(2.8)
	print "Test 4: Get y ",get_y(0.37,0.61,10)
	print "Test 5: Get y with z mirror ",get_y_with_z_mirror(-10,0.61)
	pos = [20,-10]
	print "Test 6: Get C1 ",get_C_1(pos,0.61)
	print "Test 7: Get C ",get_c(0.61)
	print "Test 8: GetC0 From Log ",get_C0_from_log(-0.5)
	print "Test 9: Get Z Unmirrored ",get_z_unmirrored(-10,0.61)
	print "Test 10: Get Y Diff ",get_y_diff(-10,0.61)
	#print "Test 11: Ds ",ds(100,0.61)
	testpos=[0,-100]
	testpos2=[10,-90]
	print "Test 12: Ds ",get_z_mirrored(testpos, testpos2,0.61)
	print "Test 13: Path Length ",get_path_length(testpos, testpos2,0.61)
	print "Test 14: Travel Time ",get_travel_time(testpos, testpos2,0.61)
	print "Test 15: Att Length ",get_attenuation_length(-10, 0.1)
	print "Test 16: Att Along path ",get_attenuation_along_path(testpos,testpos2,0.61,[0.1,0.2])
	print "Test 17: Angle ",get_angle(testpos,testpos2,0.61)
	print "Test 18: Launch, Receive ",get_launch_angle(testpos,0.61)," ",get_receive_angle(testpos,testpos2,0.61)
	print "Test 19: Delta Y ",get_delta_y(0.61,testpos,testpos2)
	print "Test 20: Obj Delta Y Square, Obj Delta Y ",obj_delta_y_square(-1,testpos,testpos2)," ",obj_delta_y(-0.49,testpos,testpos2)
	print "Test 21: Solution Type ",determine_solution_type(testpos,testpos2,0.61)
	print "Test 22: Find Solutions ",find_solutions(testpos,testpos2)
	res, zs = get_path(testpos, testpos2, 0.8479, n_points=10)
	print "Test 23"
	print res
	print zs
	...
	results = find_solutions(x1, x2)
	print results
	yy,zz = get_path(x1,x2,results[1]['C0'],10)
	print yy
	print zz
